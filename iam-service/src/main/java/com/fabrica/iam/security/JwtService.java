...
public class JwtService {
    ...
    public String generateToken(Usuario usuario) {
        ...
        extraClaims.put("filial", usuario.getIdFilial());
        return buildToken(extraClaims, usuario.getLogin(), jwtExpiration);
    }

    public String generateRefreshToken(Usuario usuario) {
        return buildToken(new HashMap<>(), usuario.getLogin(), jwtExpiration * 24); // 24 hours for refresh token
    }
